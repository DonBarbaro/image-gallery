...
class ApiError
{
    ...
    const TYPE_PHOTO_WITH_SAME_NAME_ALREADY_EXISTS = 'photo_with_this_name_already_exists';
    ...
    private static $titles = array(
        ...
        self::TYPE_PHOTO_WITH_SAME_NAME_ALREADY_EXISTS => 'Photo with same name already exists',
